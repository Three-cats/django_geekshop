# Generated by Django 3.2.6 on 2022-05-13 17:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('mainapp', '0003_auto_20220504_1841'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statuc', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PD', 'оплачен'), ('PRD', 'обрабатывается'), ('RDY', 'готов к выдаче'), ('CNC', 'отмена заказа')], default='FM', max_length=3, verbose_name='статус')),
